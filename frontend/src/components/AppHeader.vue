  ...
  <header class="app-header-shell">
    <div class="app-header-card apple-surface">
      ...
      <div class="app-header-actions">
        ...
        <el-button
          v-if="props.showWorkspaceSwitch"
          class="header-nav-btn workspace-switch-header-btn"
          plain
          type="primary"
          @click="emit('workspace-switch')"
        >
          <el-icon><Switch /></el-icon>
          <span>{{ props.workspaceSwitchLabel }}</span>
        </el-button>
        ...
        <el-dropdown @command="emit('command', $event)">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item v-if="props.showWorkspaceSwitch" command="workspace-switch">
                {{ props.workspaceSwitchLabel }}
              </el-dropdown-item>
              <el-dropdown-item command="api-tokens">API Token</el-dropdown-item>
...
<script setup>
import { ArrowDown, Guide, Upload, Switch } from '@element-plus/icons-vue'
...
const emit = defineEmits(['command', 'workspace-switch'])
</script>
