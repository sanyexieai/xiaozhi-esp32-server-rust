    ...
    children: [
      ...
      // 管理员路由
      {
        ...
        children: [
          ...
          {
            path: 'device-chat-simulator',
            name: 'DeviceChatSimulator',
            component: () => import('../views/admin/DeviceChatSimulator.vue'),
            meta: { title: '设备对话模拟' }
          },
          {
            path: 'vision-config',
          ...
          {
            path: 'chat-history/messages',
            name: 'AdminChatMessages',
            component: () => import('../views/admin/ChatHistoryMessages.vue'),
            meta: { title: '全部消息' }
          },
          {
            path: 'history/sessions/:sessionId',
            name: 'AdminChatSessionDetail',
            component: () => import('../views/admin/ChatSessionDetail.vue'),
            meta: { title: '会话详情' }
          }
        ]
      },
      ...
      {
        path: '/user/agents/:id/history/messages',
        name: 'AgentHistoryMessages',
        component: () => import('../views/user/ChatHistoryViewAgentMessages.vue'),
        meta: { title: '全部消息' }
      },
      {
        path: '/user/agents/:id/history/sessions/:sessionId',
        name: 'AgentSessionDetail',
        component: () => import('../views/user/AgentSessionDetail.vue'),
        meta: { title: '会话详情' }
      },
      {
        path: '/user/history',
      ...
      {
        path: '/user/history/messages',
        name: 'UserChatMessages',
        component: () => import('../views/user/ChatMessages.vue'),
        meta: { title: '全部消息' }
      },
      {
        path: '/user/history/sessions/:sessionId',
        name: 'UserChatSessionDetail',
        component: () => import('../views/user/ChatSessionDetail.vue'),
        meta: { title: '会话详情' }
      },
