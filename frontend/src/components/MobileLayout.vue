    ...
    >
      <div class="user-menu">
        ...
        <van-cell-group inset>
          ...
          <van-cell v-if="authStore.isAdmin" :title="switchLabel" is-link @click="handleSwitchWorkspace" />
          <van-cell title="API Token" is-link @click="handleGoApiTokens" />
          <van-cell v-if="authStore.showAdminConsole" title="配置向导" is-link @click="handleGoConfigWizard" />
...
const { switchLabel, handleWorkspaceSwitch } = useWorkspaceSwitch()
